...
TOKEN = '7240477092:AAH8yhqEZmwKMoovDu1jj22VRE3p3tH9Wo8'
...
FORWARD_CHANNEL_ID = -1002199956740
CHANNEL_ID = -1002199956740
error_channel_id = -1002199956740
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/BGMI_VIP_MODZ/296*", parse_mode='Markdown')
